...
export default function ProductsView() {
  // momentaneous...
  const userEmail = "";
  const loadedData = !localStorage.getItem("productsData") ? false : true;
  // States
  const [productsData, setProductsData] = useState(loadedData ? JSON.parse(localStorage.getItem("productsData")) : productsMockData);
  if (!loadedData){
